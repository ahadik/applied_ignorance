...
from fantasy_agent.drafting.controller import build as controller_state
from fantasy_agent.drafting.draft import snake_picks
from fantasy_agent.drafting.draft_data import read_pre_draft_context
from fantasy_agent.drafting.draft_strategy import Engine, ROOT, load_policy, owner, render
    ...
    try:
        if args.command in ('sync','accept'):
            if args.command=='sync':
                context = read_pre_draft_context(load_config(path=args.config))
