...
from fantasy_agent.providers.provider_freeze import ROOT,LOCK
...
def prefetch(season):
    ...
    from fantasy_agent.drafting.draft_board import make_board,export_candidates,render
    ...
    try:
        if args.command=='prefetch':
            ...
            if args.command=='verify':
                ...
                from fantasy_agent.providers.fantasypros import FantasyPros
                from fantasy_agent.providers.provider_freeze import FrozenNetwork
