...
python3 -m fantasy_agent lineup_history record --lineup FILE --rationale-file TEXT_FILE
...
from fantasy_agent.weekly.weekly_data import ROOT, stamp, fingerprint
from fantasy_agent.weekly.lineup_validation import check_document
