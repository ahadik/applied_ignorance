...
The saved league snapshot at 2026-09-09T03:41:54Z has full PPR, four-point passing
touchdowns, and QB / RB / RB / WR / WR / TE / FLEX / K / DEF with five bench slots.
...
5. **Produce a review report and decision record.** Show starter, slot, opponent,
   kickoff, projected points and scoring basis, injury/role evidence, best bench
   alternative, projected difference, source ages and remaining blockers. Save
