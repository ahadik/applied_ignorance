...
Offline verification: 51 tests pass across the project, including cache expiration,
restart persistence, mutable-resource freshness, invalidation, concurrent misses,
retry limits, Retry-After, invalid data, and live-draft retry overrides. No live
