...
from automation_deadlines import local_instants
from automation_store import AutomationStore, InvalidContract, UnknownSchema, digest, instant, text, utc, validate_check
    ...
    for item in selected:
        ...
        desired.append({**item, 'template_version': 1,
                        'prompt': ('Read docs/M2_AUTOMATION.md. This is a record-only check. '
                                   'Run python3 automation.py context --check-id ' + item['check_id'] +
