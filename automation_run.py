...
from automation_store import AutomationStore, AutomationError, InvalidContract, digest, instant, text, utc
...
class Workflow:
    ...
    def deadline(self, recipe, run, folder):
        ...
        from lineup_validation import proposal_from_report, validate, check_document
