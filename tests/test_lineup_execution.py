...
from lineup_execution import Execution, observe
...
class ExecutionTests(unittest.TestCase):
    def setUp(self):
        ...
        self.native = {'account': 'owner', 'url': 'https://sleeper.com/leagues/test/team',
    ...
    def test_observation_retains_disagreement_without_relaxing_production_collection(self):
        ...
        with patch('lineup_execution.context', return_value=ctx) as read:
