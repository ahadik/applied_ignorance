...
from automation_reconcile import SchedulerStore, read_local, marker
from automation_store import AutomationStore, AutomationError, InvalidContract, StaleRevision, digest, instant, utc
from automation_run import Workflow, register_workflow, validate_recipe
...
class Dispatcher:
    ...
    def prepare(self, target, expires):
        ...
        prompt = (f'Continue the Fantasy Football M4 dispatcher in {self.root}. '
                  ...
                  f'Otherwise run python3 automation_dispatch.py tick --revision {revision}. '
